...
class server_t
{
    ...
    server_handler_t error_handler;
  ...
  public:
    ...
    server_t &at_client_connection_error(server_handler_t handler);
...
class client_t
{
    ...
    client_handler_t error_handler;
    event_context_t *context;
    void wait_server(socket_addr_t address);
  ...
  public:
    ...
    client_t &at_server_connection_error(client_handler_t handler);
